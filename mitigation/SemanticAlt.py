...
from diffusers.utils import deprecate, logging, randn_tensor, replace_example_docstring
from diffusers.pipeline_utils import DiffusionPipeline
from diffusers.pipelines.stable_diffusion.safety_checker import StableDiffusionSafetyChecker
from diffusers.pipelines.alt_diffusion import AltDiffusionPipelineOutput, RobertaSeriesModelWithTransformation
...
class SemanticAltDiffusionPipeline(DiffusionPipeline, TextualInversionLoaderMixin):
    r"""
    ...
    def _encode_prompt(
        ...
        if do_classifier_free_guidance and editing_prompt is not None and edit_prompt_embeds is None:
            ...
            if isinstance(self, TextualInversionLoaderMixin):
                edit_tokens = self.maybe_convert_prompt(edit_tokens, self.tokenizer)
    ...
    def __call__(
        ...
        prompt_embeds, negative_prompt_embeds, edit_prompt_embeds = self._encode_prompt(
            prompt=prompt,
